**==dcream.spg  processed by SPAG 5.00N  at 11:12 on 23 Mar 1999
      SUBROUTINE DCREAM(Maxitm,Fpn,Nitem)
      IMPLICIT NONE
C
C ======================================================================
C
C  PURPOSE:
C       Decode several FLOATING POINT number(s) in single precision.
C
C  METHOD:
C       Loop and call DCREAL to decode max MAXITM, FLOATING
C       POINT number(s)
C
C  ERROR HANDLING:
C       See DCREAL
